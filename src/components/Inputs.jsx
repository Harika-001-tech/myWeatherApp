  ...
  return (
    <div className="flex flex-row justify-center my-6">
        <div className=" flex flex-row w-3/4 items-center justify-center space-x-4">
            ...
            <BiSearch size={30} onClick={handleSearchClick} className="cursor-pointer ease-out hover:scale-125"/>
        <BiCurrentLocation size={30}  onClick={handleLocationClick}   className="cursor-pointer ease-out hover:scale-125"/>
